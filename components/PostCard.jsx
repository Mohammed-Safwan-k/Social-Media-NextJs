    ...
    <Card>
      <div className="flex gap-3">
        ...
        <div className="relative">
          ...
          {dropdownOpen && (
            <div className="w-5 h-5 absolute top-0 cursor-pointer"></div>
          )}
              ...
              {dropdownOpen && (
                <div className="absolute right-0 bg-white shadow-md shadow-gray-300 p-3 rounded-sm border border-gray-100 w-52">
                  <button onClick={toggleSave} className="w-full -my-2">
                    <span className="flex gap-3 py-2 my-2 hover:bg-socialOrange hover:bg-opacity-70 hover:text-white -mx-2 px-4 rounded-md transition-all hover:scale-110 hover:shadow-md shadow-gray-300">
                      {!isSaved && (
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          fill="none"
