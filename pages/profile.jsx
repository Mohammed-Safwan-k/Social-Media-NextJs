                ...
                <div className="text-right">
                  {isMyUser && !editMode && (
                    <button
                      ...
                      className="inline-flex gap-1 mx-1 bg-white rounded-md shadow-sm shadow-gray-500 py-1 px-2 "
                    >
                      <svg
